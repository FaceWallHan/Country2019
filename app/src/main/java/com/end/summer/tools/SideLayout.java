...
public class SideLayout extends FrameLayout {
    ...
    private float startX,downX;
    private float startY,downY;
    private OnSlideChangeListener onSlideChangeListener;

    public void setOnSlideChangeListenr(OnSlideChangeListener onSlideChangeListener) {
        this.onSlideChangeListener = onSlideChangeListener;
    }

    public interface OnSlideChangeListener {
        void onMenuOpen(SideLayout slideLayout);

        void onMenuClose(SideLayout slideLayout);

        void onClick(SideLayout slideLayout);
    }

    public SideLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
